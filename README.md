...
Protótipo criado para apoiar a modelagem, validação, roteamento e priorização de demandas operacionais com uso de IA Generativa.
...
**Acesse:**  
https://thaycarv.github.io/prioriza-operacoes

---

### Implanta

Protótipo criado para apoiar a organização e o acompanhamento de processos de implantação, com foco em etapas, pendências, responsáveis, status e previsibilidade das entregas.
...
- Estruturar o problema de escuta e organização de feedbacks
- Definir categorias de análise e critérios de classificação
- Organizar o fluxo de registro, leitura e interpretação das informações
